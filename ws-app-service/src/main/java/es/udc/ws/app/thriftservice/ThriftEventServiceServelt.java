...
public class ThriftEventServiceServelt extends ThriftHttpServletTemplate {
    public ThriftEventServiceServelt() {
        super(createProcessor(), createProtocolFactory());
    }

    private static TProcessor createProcessor(){
        return new ThriftEventService.Processor<ThriftEventService.Iface>( new ThriftEventServiceImpl());
    }
